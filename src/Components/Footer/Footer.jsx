    ...
    <div className="bg-[#101727]">
      <div className="max-w-7xl mx-auto pt-32 pb-8 space-y-20">
        <div className="flex justify-center items-center">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:flex gap-4 lg:gap-12">
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:justify-between pt-8 border-t-2 border-[#FAFAFA]">
          <div>
